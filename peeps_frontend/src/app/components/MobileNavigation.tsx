...
export const MobileNavigation = () => {
  const { activeAddress, userData, hasProfile } = usePeepsContext();
    ...
    <ul className="fixed bottom-0 w-full mx-auto bg-base-200 dark:bg-base-300 menu menu-horizontal justify-center border-t-2 border-base-100 dark:border-[#4563eb] px-0 lg:hidden *:flex-1 gap-x-0.5 *:flex *:flex-row *:justify-center *:items-center">
      <li>
        <Link
          href={"/"}
          className={
            "flex flex-row flex-nowrap justify-center text-center rounded-xl"
          }
        >
      ...
      <li>
        <Link
          href={"/trending"}
          className={
            "flex flex-row flex-nowrap justify-center text-center rounded-xl active:bg-base-300"
          }
        >
      ...
      {pathname === "/" &&
        (walletStatus === "connected" ? (
          ...
          <li>
            <div
              className={
                "flex flex-row flex-nowrap justify-center text-center bg-primary-content dark:bg-[#4563eb]/40 rounded-box"
              }
      ...
      <li>
        <Link
          href={"/wallet"}
          className={
            "flex flex-row flex-nowrap text-center rounded-xl text-ellipsis overflow-x-hidden whitespace-nowrap"
          }
        >
      ...
      <li>
        <Link
          ...
          className={
            "flex flex-row flex-nowrap gap-x-3 rounded-xl active:bg-base-300"
          }
        >
